...
namespace YurtKayitSistemi
{
    public partial class FrmOgrListe : Form
    {
        ...
        {
            // TODO: Bu kod satırı 'yurtOtomasyonuDataSet6.Ogrenciler' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.ogrencilerTableAdapter2.Fill(this.yurtOtomasyonuDataSet6.Ogrenciler);
        }
        int secilen;
